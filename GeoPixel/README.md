<p align="center">
  <img src="docs/logo.png" alt="GeoPixel logo:d" width="200" />
</p>
<p align="center">
...
说出你的要求，**GeoPixel** 会为你构筑一个完整的虚拟世界。
...
只需要这一句话，剩下的交给 GeoPixel。
<table>
<tr>
<td align="center" valign="top" width="50%"><img src="docs/screenshot1.png" alt="GeoPixel: one-sentence world creation interface" width="400"/></td>
<td align="center" valign="top" width="50%"><img src="docs/screenshot2.png" alt="GeoPixel: pixel world simulation with character dialogue sidebar" width="400"/></td>
</tr>
<tr>
<td align="center" valign="top" width="50%"><img src="docs/screenshot3.png" alt="GeoPixel: pixel world simulation with character dialogue sidebar" width="400"/></td>
<td align="center" valign="top" width="50%"><img src="docs/screenshot2_en.png" alt="GeoPixel: one-sentence world creation interface" width="400"/></td>
</tr>
</table>
...
GeoPixel 使用 **4 个模型角色**，各自独立配置。除绘图模型支持 Google AI Studio 原生图片接口外，其余角色均采用 OpenAI 兼容的 `chat/completions` 协议。
